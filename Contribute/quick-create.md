...
* Se [Nyheter i Visual Studio för Mac](https://visualstudio.microsoft.com/vs/mac/).
:::zone-end
...
Kontrollera att du ersatte namnet <YourKeyVaultName> med namnet på ditt valv ::: zone-end
